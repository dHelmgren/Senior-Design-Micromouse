...
void main(void)
{
	// Iterates over each set of 3 sensor values
	while(*clickPtr){
		...
		// Debug
		// Print the results, just to be sure
		/* printf("\nNew run!!!!: \n");
		printf("\nFlo: %d,", (int)(left*100));
		printf("%d,", (int)(straight*100));
		printf("%d", (int)(right*100));*/

		// Call the actual Minitaur code to process the sensor inputs
		minitaurMain(left, straight, right);
